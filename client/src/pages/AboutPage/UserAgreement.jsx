      ...
      <section className='terms'>
        ...
        <div>
          ...
          <p>
            ...
            <a href='http://localhost:3000'>https://motosoul.ru</a>, а также Мобильное приложение MotoSoul, обеспечивающий, в т.ч.:
          </p>
          ...
          <p>
            1.4. Сайт – <a href='http://localhost:3000'>https://motosoul.ru</a>.
          </p>
          <p>
          ...
          <p>
            ...
            <a href='http://localhost:3000'>ограниченного исполнением обязательств Сторон, которые могут возникнуть в рамках соответствующих уровней доступа</a>.
          </p>
          ...
          <p>
            ...
            <a href='http://localhost:3000'>https://motosoul.ru</a>, и принять осознанное решение об использовании Сервиса.
          </p>
          ...
          <p>
            В целях отказа от информирования Вы можете направить нам сообщение на<a href='http://localhost:3000'>info@motosoul.ru</a> об отказе{' '}
            <u>от получения информационных сообщений уведомительного характера</u>. При получении отказа от информирования Компания исключает Вас из рассылки информационных сообщений, за исключением
            тех сообщений, для направления которых действующее законодательство не предусматривает необходимость получения Вашего согласия. При этом Вы осознаете, что предоставление Сервиса без
            получения уведомлений, связанных с исполнением Договора MotoSoul, Договора аренды ТС, может оказаться невозможным.
          </p>
          <p>
            <a href='http://localhost:3000'>
